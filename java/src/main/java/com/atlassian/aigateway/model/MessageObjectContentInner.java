...
import com.atlassian.aigateway.model.MessageContentImageFileObject;
import com.atlassian.aigateway.model.MessageContentImageFileObjectImageFile;
import com.atlassian.aigateway.model.MessageContentImageUrlObject;
import com.atlassian.aigateway.model.MessageContentImageUrlObjectImageUrl;
import com.atlassian.aigateway.model.MessageContentTextObject;
import com.atlassian.aigateway.model.MessageContentTextObjectText;
...
public class MessageObjectContentInner extends AbstractOpenApiSchema {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<MessageObjectContentInner>() {
                ...
                public void write(JsonWriter out, MessageObjectContentInner value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: MessageContentImageFileObject, MessageContentImageUrlObject, MessageContentTextObject");
                }
     ...
     * MessageContentImageFileObject, MessageContentImageUrlObject, MessageContentTextObject
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be MessageContentImageFileObject, MessageContentImageUrlObject, MessageContentTextObject");
    }
     ...
     * MessageContentImageFileObject, MessageContentImageUrlObject, MessageContentTextObject
     *
     * @return The actual instance (MessageContentImageFileObject, MessageContentImageUrlObject, MessageContentTextObject)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for MessageObjectContentInner with oneOf schemas: MessageContentImageFileObject, MessageContentImageUrlObject, MessageContentTextObject. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
