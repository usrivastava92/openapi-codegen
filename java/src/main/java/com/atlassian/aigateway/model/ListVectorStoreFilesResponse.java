...
import com.atlassian.aigateway.model.VectorStoreFileObject;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListVectorStoreFilesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListVectorStoreFilesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
