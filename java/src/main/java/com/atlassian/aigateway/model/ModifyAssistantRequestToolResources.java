...
import com.atlassian.aigateway.model.ModifyAssistantRequestToolResourcesCodeInterpreter;
import com.atlassian.aigateway.model.ModifyAssistantRequestToolResourcesFileSearch;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModifyAssistantRequestToolResources.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModifyAssistantRequestToolResources` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
