...
import com.atlassian.aigateway.model.VectorStoreExpirationAfter;
import com.atlassian.aigateway.model.VectorStoreObjectFileCounts;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VectorStoreObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VectorStoreObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
