...
|**attachments** | [**List&lt;MessageObjectAttachmentsInner&gt;**](MessageObjectAttachmentsInner.md) | A list of files attached to the message, and the tools they were added to. |  |
