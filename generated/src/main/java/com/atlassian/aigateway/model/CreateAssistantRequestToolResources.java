...
import com.atlassian.aigateway.model.CreateAssistantRequestToolResourcesFileSearch;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateAssistantRequestToolResources.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateAssistantRequestToolResources` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
